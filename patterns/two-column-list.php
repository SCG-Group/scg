...
<div class="wp-block-columns">
	...
	<div class="wp-block-column" style="flex-basis:50%">
		<!-- wp:list {"ordered":true,"start":3,"fontSize":"32","className":"is-style-inside"} -->
		<ol start="3" class="wp-block-list has-32-font-size is-style-inside">
			<!-- wp:list-item {"style":{"typography":{"fontWeight":"700","fontStyle":"normal"}}} -->
	...
	<div class="wp-block-column" style="flex-basis:50%">
		...
		<ol class="wp-block-list is-style-spaced">
			<!-- wp:list-item -->
			<li>Nullam ac <strong>sapien at erat tempor</strong> condimentum.</li>
			<!-- /wp:list-item -->

			<!-- wp:list-item -->
			<li>Phasellus gravida elit a lectus sodales dignissim.
				<!-- wp:list -->
