...
<div
	...
	data-wp-interactive="scg/cert-viewer">
		<?php if ( isset( $category ) ) : ?>
			<div class="wp-block-scg-cert__category"><?php echo esc_html( $category ); ?></div>
		<?php endif; ?>
		<div class="wp-block-scg-cert__details is-layout-flex" tabindex="0" data-wp-on-async--click="actions.onCertClick">
			<?php
			if ( isset( $img ) ) {
